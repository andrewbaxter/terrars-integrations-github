...
#[derive(Serialize)]
struct ActionsOrganizationSecretData {
...
struct ActionsOrganizationSecret_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ActionsOrganizationSecretData>,
}

#[derive(Clone)]
pub struct ActionsOrganizationSecret(Rc<ActionsOrganizationSecret_>);

impl ActionsOrganizationSecret {
...
impl Referable for ActionsOrganizationSecret {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ActionsOrganizationSecret { }

impl ToListMappable for ActionsOrganizationSecret {
    type O = ListRef<ActionsOrganizationSecretRef>;
...
impl Resource_ for ActionsOrganizationSecret_ {
    fn extract_resource_type(&self) -> String {
        "github_actions_organization_secret".into()
    }
...
pub struct BuildActionsOrganizationSecret {
    pub tf_id: String,
...
impl BuildActionsOrganizationSecret {
    pub fn build(self, stack: &mut Stack) -> ActionsOrganizationSecret {
        let out = ActionsOrganizationSecret(Rc::new(ActionsOrganizationSecret_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ActionsOrganizationSecretData {
...
pub struct ActionsOrganizationSecretRef {
    shared: StackShared,
    base: String,
}

impl Ref for ActionsOrganizationSecretRef {
...
impl ActionsOrganizationSecretRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
