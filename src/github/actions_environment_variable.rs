...
#[derive(Serialize)]
struct ActionsEnvironmentVariableData {
...
struct ActionsEnvironmentVariable_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ActionsEnvironmentVariableData>,
}

#[derive(Clone)]
pub struct ActionsEnvironmentVariable(Rc<ActionsEnvironmentVariable_>);

impl ActionsEnvironmentVariable {
...
impl Referable for ActionsEnvironmentVariable {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ActionsEnvironmentVariable { }

impl ToListMappable for ActionsEnvironmentVariable {
    type O = ListRef<ActionsEnvironmentVariableRef>;
...
impl Resource_ for ActionsEnvironmentVariable_ {
    fn extract_resource_type(&self) -> String {
        "github_actions_environment_variable".into()
    }
...
pub struct BuildActionsEnvironmentVariable {
    pub tf_id: String,
...
impl BuildActionsEnvironmentVariable {
    pub fn build(self, stack: &mut Stack) -> ActionsEnvironmentVariable {
        let out = ActionsEnvironmentVariable(Rc::new(ActionsEnvironmentVariable_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ActionsEnvironmentVariableData {
...
pub struct ActionsEnvironmentVariableRef {
    shared: StackShared,
    base: String,
}

impl Ref for ActionsEnvironmentVariableRef {
...
impl ActionsEnvironmentVariableRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
