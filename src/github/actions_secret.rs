...
struct ActionsSecret_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ActionsSecretData>,
}

#[derive(Clone)]
pub struct ActionsSecret(Rc<ActionsSecret_>);
...
impl Referable for ActionsSecret {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ActionsSecret { }

impl ToListMappable for ActionsSecret {
    type O = ListRef<ActionsSecretRef>;
...
impl Resource_ for ActionsSecret_ {
    fn extract_resource_type(&self) -> String {
        "github_actions_secret".into()
    }
...
impl BuildActionsSecret {
    pub fn build(self, stack: &mut Stack) -> ActionsSecret {
        let out = ActionsSecret(Rc::new(ActionsSecret_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ActionsSecretData {
...
pub struct ActionsSecretRef {
    shared: StackShared,
    base: String,
}

impl Ref for ActionsSecretRef {
