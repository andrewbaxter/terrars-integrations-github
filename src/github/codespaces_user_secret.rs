...
#[derive(Serialize)]
struct CodespacesUserSecretData {
...
struct CodespacesUserSecret_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<CodespacesUserSecretData>,
}

#[derive(Clone)]
pub struct CodespacesUserSecret(Rc<CodespacesUserSecret_>);

impl CodespacesUserSecret {
...
impl Referable for CodespacesUserSecret {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for CodespacesUserSecret { }

impl ToListMappable for CodespacesUserSecret {
    type O = ListRef<CodespacesUserSecretRef>;
...
impl Resource_ for CodespacesUserSecret_ {
    fn extract_resource_type(&self) -> String {
        "github_codespaces_user_secret".into()
    }
...
pub struct BuildCodespacesUserSecret {
    pub tf_id: String,
    #[doc= "Name of the secret."]
    pub secret_name: PrimField<String>,
}

impl BuildCodespacesUserSecret {
    pub fn build(self, stack: &mut Stack) -> CodespacesUserSecret {
        let out = CodespacesUserSecret(Rc::new(CodespacesUserSecret_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(CodespacesUserSecretData {
...
pub struct CodespacesUserSecretRef {
    shared: StackShared,
    base: String,
}

impl Ref for CodespacesUserSecretRef {
